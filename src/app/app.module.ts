...
import { OrderModalComponent } from './admin/admin-orders/order-modal/order-modal.component';
...
@NgModule({
  ...
  entryComponents: [IconModalComponent, UserModalComponent, OrderModalComponent]
})
